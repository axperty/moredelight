...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        ModItemList.WOODEN_KNIFE = item("wooden_knife", new KnifeItem(ModMaterials.WOOD_MATERIAL, new Item.Settings().attributeModifiers(KnifeItem.createAttributeModifiers(ModMaterials.WOOD_MATERIAL, .5f, -1.8F))));

        ModItemList.STONE_KNIFE = item("stone_knife", new KnifeItem(ModMaterials.STONE_MATERIAL, new Item.Settings().attributeModifiers(KnifeItem.createAttributeModifiers(ModMaterials.WOOD_MATERIAL, 1.1f, -1.8F))));
