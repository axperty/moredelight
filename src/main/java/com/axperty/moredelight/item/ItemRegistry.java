...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> WOODEN_KNIFE = ITEMS.register("wooden_knife",
            () -> new KnifeItem(TierRegistry.WOOD, 0, -1.8F, new Item.Properties().tab(CreativeTabRegistry.CREATIVE_MODE_TAB)));

    public static final RegistryObject<Item> STONE_KNIFE = ITEMS.register("stone_knife",
            () -> new KnifeItem(TierRegistry.STONE, 0, -1.8F, new Item.Properties().tab(CreativeTabRegistry.CREATIVE_MODE_TAB)));
    ...
    public static final RegistryObject<Item> DICED_POTATOES = ITEMS.register("diced_potatoes",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder())
                    .nutrition(2)
                    .saturationMod(0.4f)
                    .build()).tab(CreativeTabRegistry.CREATIVE_MODE_TAB)));
    ...
    public static final RegistryObject<Item> COOKED_RICE_WITH_CHICKEN_CUTS = ITEMS.register("cooked_rice_with_chicken_cuts",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder())
                    .nutrition(14)
                    .saturationMod(0.8f)
                    .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), FoodValues.MEDIUM_DURATION, 0), 1.0F)
                    .build()).tab(CreativeTabRegistry.CREATIVE_MODE_TAB), true));
