...
public class CreativeTabRegistry {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MOREDELIGHT_TAB = CREATIVE_MODE_TABS.register("moredelight_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ItemRegistry.COOKED_RICE_WITH_CHICKEN_CUTS.get());
                output.accept(ItemRegistry.COOKED_RICE_WITH_BEEF.get());
                output.accept(ItemRegistry.COOKED_RICE_WITH_PORKCHOP.get());
                output.accept(ItemRegistry.CREAMY_PASTA_WITH_HAM.get());
                output.accept(ItemRegistry.CREAMY_PASTA_WITH_CHICKEN_CUTS.get());
                output.accept(ItemRegistry.MASHED_POTATOES.get());
                output.accept(ItemRegistry.DICED_POTATOES_WITH_CHICKEN_CUTS.get());
                output.accept(ItemRegistry.DICED_POTATOES_WITH_BEEF.get());
                output.accept(ItemRegistry.DICED_POTATOES_WITH_PORKCHOP.get());
                output.accept(ItemRegistry.DICED_POTATOES_WITH_EGG_AND_TOMATO.get());
                ...
                if (ModList.get().isLoaded("expandeddelight")) {
                    output.accept(ItemRegistry.TOAST_WITH_PEANUT_BUTTER.get());
                }
            })
            .build());
}
