    ...
    public static final RegistryObject<CreativeModeTab> CREATIVE_TAB = CREATIVE_MODE_TABS.register("creative_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((displayParams, pOutput) -> {
                        ...
                        pOutput.accept(ItemRegistry.COOKED_RICE_WITH_CHICKEN_CUTS.get());
                        pOutput.accept(ItemRegistry.COOKED_RICE_WITH_BEEF.get());
                        pOutput.accept(ItemRegistry.COOKED_RICE_WITH_PORKCHOP.get());
                        pOutput.accept(ItemRegistry.CREAMY_PASTA_WITH_HAM.get());
                        pOutput.accept(ItemRegistry.CREAMY_PASTA_WITH_CHICKEN_CUTS.get());
                        pOutput.accept(ItemRegistry.MASHED_POTATOES.get());
                        pOutput.accept(ItemRegistry.DICED_POTATOES_WITH_CHICKEN_CUTS.get());
                        pOutput.accept(ItemRegistry.DICED_POTATOES_WITH_BEEF.get());
                        pOutput.accept(ItemRegistry.DICED_POTATOES_WITH_PORKCHOP.get());
                        pOutput.accept(ItemRegistry.DICED_POTATOES_WITH_EGG_AND_TOMATO.get());
