...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> WOODEN_KNIFE = ITEMS.register("wooden_knife",
            () -> new KnifeItem(MaterialRegistry.WOOD, 0, -1.8F, new Item.Properties()));

    public static final RegistryObject<Item> STONE_KNIFE = ITEMS.register("stone_knife",
            () -> new KnifeItem(MaterialRegistry.STONE, 0, -1.8F, new Item.Properties()));

    public static final RegistryObject<Item> DICED_POTATOES = ITEMS.register("diced_potatoes",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(2).saturationMod(0.4f).fast().build())));

    public static final RegistryObject<Item> OMELETTE = ITEMS.register("omelette",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(6).saturationMod(0.6f).build())));

    public static final RegistryObject<Item> CHOCOLATE_POPSICLE = ITEMS.register("chocolate_popsicle",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(3).saturationMod(0.2f).build())));

    public static final RegistryObject<Item> COOKED_RICE_WITH_CHICKEN_CUTS = ITEMS.register("cooked_rice_with_chicken_cuts",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(14).saturationMod(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), FoodValues.MEDIUM_DURATION, 0), 1.0F).build()), true));

    public static final RegistryObject<Item> COOKED_RICE_WITH_BEEF = ITEMS.register("cooked_rice_with_beef",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(14).saturationMod(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), FoodValues.MEDIUM_DURATION, 0), 1.0F).build()), true));

    public static final RegistryObject<Item> COOKED_RICE_WITH_PORKCHOP = ITEMS.register("cooked_rice_with_porkchop",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(14).saturationMod(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), FoodValues.MEDIUM_DURATION, 0), 1.0F).build()), true));

    public static final RegistryObject<Item> CREAMY_PASTA_WITH_HAM = ITEMS.register("creamy_pasta_with_ham",
    ...
    public static final RegistryObject<Item> CREAMY_PASTA_WITH_CHICKEN_CUTS = ITEMS.register("creamy_pasta_with_chicken_cuts",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(12).saturationMod(0.8f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), FoodValues.MEDIUM_DURATION, 0), 1.0F).build()), true));

    public static final RegistryObject<Item> MASHED_POTATOES = ITEMS.register("mashed_potatoes",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(12).saturationMod(0.8f).build())));

    public static final RegistryObject<Item> DICED_POTATOES_WITH_CHICKEN_CUTS = ITEMS.register("diced_potatoes_with_chicken_cuts",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(10).saturationMod(0.8f).build())));

    public static final RegistryObject<Item> DICED_POTATOES_WITH_BEEF = ITEMS.register("diced_potatoes_with_beef",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(10).saturationMod(0.8f).build())));

    public static final RegistryObject<Item> DICED_POTATOES_WITH_PORKCHOP = ITEMS.register("diced_potatoes_with_porkchop",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(10).saturationMod(0.8f).build())));

    public static final RegistryObject<Item> DICED_POTATOES_WITH_EGG_AND_TOMATO = ITEMS.register("diced_potatoes_with_egg_and_tomato",
            () -> new ConsumableItem(bowlFoodItem((new FoodProperties.Builder()).nutrition(10).saturationMod(0.8f).build())));
    ...
    public static final RegistryObject<Item> HAMBURGER_WITH_CHEESE = ITEMS.register("hamburger_with_cheese",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(9).saturationMod(0.8f).build())));
    ...
    public static final RegistryObject<Item> LOADED_HAMBURGER = ITEMS.register("loaded_hamburger",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(13).saturationMod(0.8f).build())));
    ...
    public static final RegistryObject<Item> CHICKEN_SANDWICH_WITH_EGG_AND_TOMATO = ITEMS.register("chicken_sandwich_with_egg_and_tomato",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(11).saturationMod(0.8f).build())));

    public static final RegistryObject<Item> STEAK_SANDWICH = ITEMS.register("steak_sandwich",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(10).saturationMod(0.8f).build())));
    ...
    public static final RegistryObject<Item> TOMATO_SANDWICH = ITEMS.register("tomato_sandwich",
            () -> new ConsumableItem(foodItem((new FoodProperties.Builder()).nutrition(7).saturationMod(0.8f).build())));
