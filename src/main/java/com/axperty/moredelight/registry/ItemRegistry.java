...
public class ItemRegistry {
    ...
    public static Item COOKED_RICE_WITH_CHICKEN_CUTS = consumableEffect("cooked_rice_with_chicken_cuts", 14, 0.8f, ModEffects.NOURISHMENT.get(), 3600, 0, 16, Items.BOWL);

    public static Item COOKED_RICE_WITH_BEEF = consumableEffect("cooked_rice_with_beef", 14, 0.8f, ModEffects.NOURISHMENT.get(), 3600, 0, 16, Items.BOWL);

    public static Item COOKED_RICE_WITH_PORKCHOP = consumableEffect("cooked_rice_with_porkchop", 14, 0.8f, ModEffects.NOURISHMENT.get(), 3600, 0, 16, Items.BOWL);

    public static Item CREAMY_PASTA_WITH_HAM = consumableEffect("creamy_pasta_with_ham", 12, 0.8f, ModEffects.NOURISHMENT.get(), 3600, 0, 16, Items.BOWL);

    public static Item CREAMY_PASTA_WITH_CHICKEN_CUTS = consumableEffect("creamy_pasta_with_chicken_cuts", 12, 0.8f, ModEffects.NOURISHMENT.get(), 3600, 0, 16, Items.BOWL);
    ...
    public static Item CARROT_SOUP = consumableEffect("carrot_soup", 12, 0.8f, ModEffects.COMFORT.get(), 3600, 0, 16, Items.BOWL);
